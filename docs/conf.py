#!/usr/bin/env python
"""
 dota2gsi documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "dota2gsi"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import dota2gsi.core  # noqa
...
project = "dota2gsi"
_full_version = dota2gsi.core.__version__
author = dota2gsi.core.__author__
copyright = dota2gsi.core.__copyright__
...
htmlhelp_basename = "dota2gsi-doc"
